import { REQUIRED_FIELD_MESSAGE, INVALID_AMOUNT_MESSAGE, INVALID_REAL_DATE_MESSAGE, INVALID_EMAIL_MESSAGE, INVALID_IBAN_MESSAGE } from "@/common/validations/validation.const";
import {
  validateIBANField,
